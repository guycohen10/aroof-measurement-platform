...
<body>
  ...
  <div class="footer">
    <p>Generated by Aroof Measurement Platform | Report Date: ${format(new Date(), 'MMMM d, yyyy')}</p>
    <p style="margin-top: 10px;">This report is for estimation purposes only. A final inspection will provide exact measurements and pricing.</p>
    <p style="margin-top: 10px;">© ${new Date().getFullYear()} Aroof. All rights reserved.</p>
  </div>
</body>
</html>
  `;
...
<head>
  <meta charset="UTF-8">
  <title>Roof Measurement Report - ${reportId}</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body {
      font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
...
<body>
  ...
  <div class="footer">
    <p>Report generated by Aroof Measurement Platform</p>
    <p style="margin-top: 5px;">This measurement uses satellite imagery and may vary slightly from actual measurements. ±2-5% accuracy.</p>
    <p style="margin-top: 5px;">© ${new Date().getFullYear()} Aroof.build. All rights reserved.</p>
  </div>
</body>
</html>
  `;
