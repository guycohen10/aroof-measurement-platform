    ...
    const checkAuth = async () => {
      try {
        ...
        if (user) {
          ...
          // Only redirect if explicitly on the homepage (prevent redirect loops on other pages)
          if (staffRoles.includes(user.aroof_role) && (window.location.pathname === '/' || window.location.pathname === '/homepage')) {
