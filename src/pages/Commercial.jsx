  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h1 className="text-5xl font-bold text-slate-900 mb-6">Commercial Roofing</h1>
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardContent className="p-6">
            <p className="text-sm text-blue-900">
              We're currently building out detailed service pages. In the meantime, our team is ready to help you with any questions about commercial roofing services.
            </p>
          </CardContent>
        </Card>
      </div>
